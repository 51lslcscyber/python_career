...
class Ui_Form(object):
    ...
    def setupUi(self, Form):
        ...
        self.label_100.setGeometry(QtCore.QRect(410, 0, 360, 41))
        # label_100里面设置框的大小为左右410，上下0,宽360,高41
    ...
    def updateTime(self):
        self.label_100.setText(QDateTime.currentDateTime().toString(
            'yyyy-MM-dd hh:mm:ss dddd'))  # 显示时间的格式
